...
#input-file=/Users/Felix/Applications/Aria2/aria2.session
# 在Aria2退出时保存`错误/未完成`的下载任务到会话文件
save-session=/Users/Felix/Applications/Aria2/aria2.session
...
#!/bin/sh
# Aria2 RPC #
/usr/local/aria2/bin/aria2c --enable-rpc=true --input-file=/Users/Felix/Applications/Aria2/aria2.session --conf-path=/Users/Felix/Applications/Aria2/aria2.conf -D
exit;
```
