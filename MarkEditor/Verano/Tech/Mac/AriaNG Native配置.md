...
1. touch命令新建4个文件：aria2.conf、aria2.session、aria2.sh、aria2.plist
2. chmod +x  赋予执行权限 
3. launchctl load 添加开机自启动
...
#input-file=/Users/YOUR PATH/Applications/Aria2/aria2.session
# 在Aria2退出时保存`错误/未完成`的下载任务到会话文件
save-session=/Users/YOUR PATH/Applications/Aria2/aria2.session
...
user-agent=aria2/1.33.0,Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.110 Safari/537.36
...
#!/bin/sh
# Aria2 RPC #
/usr/local/aria2/bin/aria2c --enable-rpc=true --input-file=/Users/YOUR PATH/Applications/Aria2/aria2.session --conf-path=/Users/YOUR PATH/Applications/Aria2/aria2.conf -D
exit;
```
...
<plist version="1.0">
    <dict>
        ...
        <array>
            <string>/Users/YOUR PATH/Applications/Aria2/aria2.sh</string> 
        </array>
        <key>WorkingDirectory</key>
        <string>/Users/YOUR PATH/Downloads</string>
    </dict>
</plist>
```
