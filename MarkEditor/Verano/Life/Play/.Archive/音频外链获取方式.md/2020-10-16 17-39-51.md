...
一、个人音频文件可以存储到OneDrive，点击分享，复制文件链接，使用[直链](https://onedrive.gimhoy.com)工具获取。（有个小bug：iPhone端会出现音频错误问题，pc端以及android移动端可以正常访问）
二、 网易音乐外链地址获取方法：
...
**目前，html5 audio 标签只能播放单个音频文件，如何要添加多个MP3音频文件，顺序连续播放，需要用JS代码来实现。**
